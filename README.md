...
OsTicket can be deployed on any device however I recommend learning the installation and configuration on a virtual machine. In this tutorial I will be using microsoft azure to create a windows 10 virtual machine in which to install the prereqs of OsTicket. Below is a video demonstration I used to practice and master this process.
